...
```
cd existing_repo
git remote add origin https://gitlab.com/greyF0xx/plantio.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/greyF0xx/plantio/-/settings/integrations)
...
You need to add "<T>" to the end of your type declaration in this file `node_modules/@angular/fire/compat/firestore/interfaces.d.ts` like this :
